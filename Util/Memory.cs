...
namespace Archipelago.ePSXe.Util
{
    public class Memory
    {
        ...
        internal static int EPSXE_PROCESSID
        {
            get
            {
        ...
        internal static readonly IntPtr processH = OpenProcess(PROCESS_VM_OPERATION | PROCESS_SUSPEND_RESUME | PROCESS_VM_READ | PROCESS_VM_WRITE, false, EPSXE_PROCESSID);
